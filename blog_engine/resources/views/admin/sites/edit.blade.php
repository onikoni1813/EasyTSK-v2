    ...
    <form action="{{ route('admin.sites.update', $site->id) }}" method="POST" class="bg-slate-950/80 border border-slate-800/80 rounded-2xl p-6 sm:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="domain" value="{{ old('domain', $site->domain) }}" placeholder="e.g. mycustomdomain.com" class="w-full px-4 py-2.5 bg-slate-900 border border-slate-800 rounded-xl text-sm text-white font-mono focus:border-emerald-500 focus:outline-none transition">
            </div>
