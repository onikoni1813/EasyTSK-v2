For developers ClkSh prepared API which returns responses in JSON or TEXT formats.
...
https://clk.sh/api?api=42b6acff8da066e5f8338de8f3d4eb94133d22d7&url=yourdestinationlink.com&alias=CustomAlias
You will get a JSON response like the following

{"status":"success","shortenedUrl":""https:\/\/clk.sh\/xxxxx""}
...
https://clk.sh/api?api=42b6acff8da066e5f8338de8f3d4eb94133d22d7&url=yourdestinationlink.com&alias=CustomAlias&format=text
 Note
...
$api_token = '42b6acff8da066e5f8338de8f3d4eb94133d22d7';
$api_url = "https://clk.sh/api?api={$api_token}&url={$long_url}&alias=CustomAlias";
...
$long_url = urlencode('yourdestinationlink.com');
$api_token = '42b6acff8da066e5f8338de8f3d4eb94133d22d7';
$api_url = "https://clk.sh/api?api={$api_token}&url={$long_url}&alias=CustomAlias&format=text";
